...
public class AbonentCreationTest extends TestBase {
    ...
    public Iterator<Object[]> validAbonentsFromJson() throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader("src/test/resources/abonents.json"));
        String json = "";
        ...
        Gson gson = new Gson();
        List<AbonentData> abonents = gson.fromJson(json, new TypeToken<List<AbonentData>>(){}.getType());
